    ...
    <div className="flex flex-col md:flex-row w-full max-w-7xl items-center justify-center px-4 sm:px-6 lg:px-12 pt-8 pb-20 sm:pb-32 gap-10">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl border border-white/20 
                   bg-white/10 dark:bg-zinc-900/30 backdrop-blur-lg cursor-grab 
                   active:cursor-grabbing w-[300px] h-[400px] max-sm:w-[200px] 
                   max-sm:h-[260px] -mt-5 sm:mt-0
      ...
      >
        ...
        />
        <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-white/10 via-transparent to-black/30 pointer-events-none" />
      </motion.div>
      ...
      <div className="flex flex-col flex-1 px-2 sm:px-4 lg:px-12 gap-6 md:gap-8 
        ...
        <TypingText text="I'm Reynard Wijaya" delay={1.6} />
          ...
          >
            ...
            <ShinyText text="Rey" speed={2} className="font-bold text-red-500" />
          </motion.p>

          {/* Passion Card + Social Links */}
          <motion.div
            initial={{ y: 30, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 3, duration: 0.8 }}
            className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-6 mt-6"
          >
            {/* Passion Card */}
            <motion.div
