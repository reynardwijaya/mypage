...
export default function NavMenu() {
  ...
  // ✨ Native smooth scroll biar langsung berfungsi
        ...
        <div>
          ...
          <MagneticEffect>
            <NavMenuLink
              ...
              active={active}
              duration={1.1}
              handleScroll={() => handleScroll("#experiences")}
            />
          </MagneticEffect>
          ...
          <div className="flex gap-x-2 px-[clamp(1.25rem,3vw,2.5rem)] text-base">
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1}
                link="https://github.com/reynardwijaya"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.2}
                link="https://www.linkedin.com/in/reynard-wijaya-377713294/"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.8}
                link="mailto:reynardwijaya710@gmail.com"
              />
            </MagneticEffect>
          </div>
